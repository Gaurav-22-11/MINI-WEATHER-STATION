...
#define SSID "Dnyanesh" //replace XXXXX by your router SSID
#define PASS "9004853210" //replace YYYYY by your router password
#define IP "184.106.153.149" // thingspeak.com IP
#define DHT22_PIN 2
String GET = "GET /update?key=ZHGSQYI15PTCHR3K&field1="; //replace ZZZZZ by your ThingSpeak channel write key
